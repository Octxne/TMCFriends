...
public class UnfriendCommand implements CommandExecutor
{
	public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments)
	{
		...
		else
		{
			...
			{
				Messages.usage(player, "/unfriend <player>");
			}
			else
			{
				...
				else
				{
					...
					{
						player.sendMessage(ChatColor.RED + "Player " + target.getName() + " is not your friend!");
					}
					else
					{
						friends.remove(target.getName());
						...
						player.sendMessage(ChatColor.GRAY + "You have " + ChatColor.RED + "removed " + ChatColor.GRAY + "player " + target.getDisplayName() + ChatColor.GRAY + " friend your friends list!");
					}
				}
			}
		}
